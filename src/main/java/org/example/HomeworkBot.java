...
public class HomeworkBot extends TelegramLongPollingBot {
    ...
    public HomeworkBot() {
        ...
        tasksDescriptionsForTeacher1.add("src/main/java/org/example/prepods/gorlanov/first/task/ПР1.zip");
        tasksDescriptionsForTeacher1.add("src/main/java/org/example/prepods/gorlanov/second/task/ПР2.zip");
        tasksDescriptionsForTeacher1.add("src/main/java/org/example/prepods/gorlanov/sql/task/SQL.zip");
        ...
        tasksFilesForTeacher1.add("src/main/java/org/example/prepods/gorlanov/first/done/(ВР1)Практическая работа №1,Фамилия_3ИСИП-122.zip"); // Выполненное задание ПР1
        tasksFilesForTeacher1.add("src/main/java/org/example/prepods/gorlanov/second/done/(ВР2)Практическая_работа_№1,Фамилия_3ИСИП_122.zip"); // Выполненное задание ПР2
            ...
            if (tasksDescriptions.containsKey(callbackData)) {
                ...
                if (action.equals("condition")) {
                    if(taskId.equals("SQL")){
                        sendTaskFile(chatId, taskId, tasksDescriptions.get("Горланов").get(2));
                    }
                    sendTaskFile(chatId, taskId, tasksDescriptions.get("Горланов").get(Integer.parseInt(taskId) - 1));
                } else if (action.equals("done")) {
                    if (taskId.equals("1")) {
                        sendTaskFilesFromDirectory(chatId, "ПР1", "src/main/java/org/example/prepods/gorlanov/first/done");
                    } else if (taskId.equals("2")) {
                        sendTaskFilesFromDirectory(chatId, "ПР2", "src/main/java/org/example/prepods/gorlanov/second/done");
                    } else if (taskId.equals("SQL")) {
                        sendTaskFilesFromDirectory(chatId, "SQL", "src/main/java/org/example/prepods/gorlanov/sql/done");
                    } else {
